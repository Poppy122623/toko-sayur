    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?php echo site_url(); ?>" class="brand-link">
                <img src="<?php echo get_store_logo(); ?>" alt="<?php echo get_store_name(); ?> Logo" class=""
                    style="opacity: .8; padding-left:25px;width:210px; height:75px;">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="<?php echo site_url('customer/profile'); ?>" class="d-block">
